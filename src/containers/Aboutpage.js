...
function Aboutpage() {
  return (
    <>
    	...
    	<Header as='h1' color='violet' textAlign='center'>Hello, I'm Sara</Header>
    	<Container>
	    	...
	    	Personable and reliable, with excellent team management and customer interaction skills. Prior education in industrial and systems engineering with a focus on sustainability. In my free time I enjoy traveling, hiking, and biking.</Header>
	    </Container>
    </>
  )
}
